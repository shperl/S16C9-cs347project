...
ALTER TABLE Person ADD CONSTRAINT employees_managing FOREIGN KEY ( person_id2 ) REFERENCES Person ( person_id ) ON
DELETE CASCADE ;
...
ALTER TABLE Person ADD CONSTRAINT manager_of_employees FOREIGN KEY ( person_id3 ) REFERENCES Person ( person_id ) ON
DELETE CASCADE ;
